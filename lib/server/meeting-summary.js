...
async function requestMeetingSummary(transcriptText, fallbackTitle) {
  ...
  const response = await client.responses.create({
    ...
    instructions: [
      ...
      "title: claro y descriptivo, identifica la reunion sin abreviar.",
      "description: 2 o 3 frases completas explicando de que trato la reunion, los temas principales y el resultado general.",
